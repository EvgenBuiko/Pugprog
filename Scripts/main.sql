...
SHOW WARNINGS;
CREATE INDEX `FK_RingID_idx` ON `mydb`.`Dog` (`RingID` ASC) VISIBLE;
...
SHOW WARNINGS;
CREATE INDEX `FK_RingID_idx` ON `mydb`.`Experts` (`RingID` ASC) VISIBLE;
